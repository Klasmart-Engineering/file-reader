...
const MetadataAvroCRC64Fingerprint = "m\x06z\n\x97\x9f~,"
...
func (r Metadata) Schema() string {
	return "{\"fields\":[{\"name\":\"origin_application\",\"type\":\"string\"},{\"name\":\"region\",\"type\":\"string\"},{\"logicalType\":\"uuid\",\"name\":\"tracking_id\",\"type\":\"string\"}],\"name\":\"com.kidsloop.onboarding.metadata\",\"type\":\"record\"}"
}

func (r Metadata) SchemaName() string {
	return "com.kidsloop.onboarding.metadata"
}
